...
os.environ.setdefault("MODEL", "minimax/MiniMax-M3")
...
def provider_config():
    ...
    return ProviderConfig(
        api_key="test_key",
        base_url="https://test.api/MiniMax-M3",
        rate_limit=10,
        rate_window=60,
    )
...
@pytest.fixture
def minimax_provider(provider_config):
    from providers.minimax import MiniMaxProvider

    return MiniMaxProvider(provider_config)
